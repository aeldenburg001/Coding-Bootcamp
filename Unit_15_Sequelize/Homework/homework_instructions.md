...
* **This assignment must be deployed.** Please submit both the deployed Heroku link to your homework AND the link to the Github Repository! See [Sequelize Heroku Deployment](../Supplemental/SequelizeDBDeploy.md)
